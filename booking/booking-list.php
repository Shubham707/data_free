                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php if($data['status']==1){?>
                       ...
                       <th><a class="btn btn-info" href="edit-resort.php?flight_id=<?= $data['book_id']?>"><i class="fa fa-pencil"></i></a><a class="btn btn-danger" href="lib/active.php?delete=<?= $data['book_id']?>""><i class="fa fa-trash"></i></a></th>
                    </tr>
                   <?php }?>
