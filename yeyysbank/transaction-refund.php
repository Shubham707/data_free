...
$url = "http://99-604-99-605.com/api/money-transfer2.php?userid=".$echarge['uid']."&key=".$echarge['key']."&request=".$_GET['request']."&mobile=".$account."&otp_ref_code=".$otp_ref_code."&otp=".otp."&txn_id=".txn_id."&amount=".amount;
