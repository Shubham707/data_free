				...
				<div class="box">
					...
					<div class="box-body min-height-300">
						<table class="table table-basic">
							...
							<tbody>
								<?php
								$query = $db->query("SELECT * FROM transactions WHERE account_id = '".$_SESSION['retailer_uid']."' AND transaction_term = 'FUND' ORDER BY transaction_id DESC LIMIT 10 ");
