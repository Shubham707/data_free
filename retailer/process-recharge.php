...
if(isset($_POST['account']) && isset($_POST['amount']) && isset($_POST['operator']) && isset($_POST['pin'])) {	
	...
	$agent_info = $db->queryUniqueObject("SELECT user_id,uid,user_type,mdist_id,dist_id,pin,tds_deduct,tds_per,gst_deduct,has_gst,gst_type FROM apps_user WHERE user_id='".$_SESSION['retailer']."' ");
	if($agent_info) {
