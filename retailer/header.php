...
<div class="header">
	<div class="container">
		...
		<ul class="nav navbar-nav pull-right">
			<p class="navbar-text"><?php echo $aRetailer->company_name;?> [ <?php echo $_SESSION['retailer_uid'];?> ]</p>
...
<div class="menu" style="background-color:<?php echo $website['menu_color'];?>">
	<div class="container">
		<div class="navbar" role="navigation">
			...
			<div id="dr-menu" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<li><a href="money-transfer3.php">Money Transfer</a></li>
