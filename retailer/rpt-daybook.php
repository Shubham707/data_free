	...
	<div class="container">
		...
		<div class="box">
			...
			<div class="box-body no-padding min-height-480">
				...
				$recharge_amt = $db->queryUniqueValue("SELECT sum(amount) from apps_recharge where status in(0,1,8) and uid='".$uid."'  and request_date like '%".$from."%' ");
				...
				<table class="table table-basic">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo round($recharge_amt,2);?></td>
