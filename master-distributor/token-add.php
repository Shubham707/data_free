...
$user_token = "0";
$user_cat = $db->queryUniqueObject("SELECT * FROM user_category WHERE name='".$user_info->user_category."' ");
if($user_cat) {
	$user_token = $user_cat->no_token;
}
?>
<style>
.box {
		...
		<div class="form-body-inner">
			...
			<input type="hidden" name="uid" value="<?php echo $user_info->uid;?>" class="form-control" />
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" name="new_token" id="new_token" value="<?php echo $user_token;?>" class="form-control input-sm" readonly="" />
					</div>
				</div>
				<div class="form-group">
