...
if(isset($_POST['submit'])) {
	if($_POST['fullname'] == '' || $_POST['company_name'] == '' || $_POST['mobile'] == '' || $_POST['email'] == '' || $_POST['address'] == '' || $_POST['state'] == '' || $_POST['uid'] == '' || $_POST['status'] == '' || $_POST['password'] == '' || $_POST['category'] == '') {
		$error = 1;		
	} else {		
								...
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">										
										<select name="category" id="category" class="form-control">
											...
											while($rlt = $db->fetchNextObject($qry)) { ?>
											<option value="<?php echo $rlt->name;?>"><?php echo $rlt->name;?></option>
											<?php } ?>
										</select>
									</div>
								</div>
