			...
			*/		
			...
			if($md_wallet && (($md_wallet->balance - $md_wallet->cuttoff) >= $amount) && ($amount > 0)) {	
				...
				*/
				...
				$db->execute("INSERT INTO `transactions`(`transaction_date`, `account_id`, `to_account_id`, `type`, `amount`, `closing_balance`, `transaction_term`, `transaction_ref_no`, `remark`, `transaction_user_type`, `transaction_by`) VALUES (NOW(), '".$_SESSION['mdistributor_uid']."', '".$uid."', 'dr', '".$amount."', '".$md_closing_balance."', 'FUND', '', '".$remark."', '3', '".$_SESSION['mdistributor_uid']."') ");
				/*
				* Credit Transaction
				*/
				...
				$db->execute("INSERT INTO `transactions`(`transaction_date`, `account_id`, `to_account_id`, `type`, `amount`, `closing_balance`, `transaction_term`, `transaction_ref_no`, `remark`, `transaction_user_type`, `transaction_by`) VALUES (NOW(), '".$wallet->uid."', '".$_SESSION['mdistributor_uid']."', 'cr', '".$amount."', '".$closing_balance."', 'FUND', '', '".$remark."', '3', '".$_SESSION['mdistributor_uid']."') ");
