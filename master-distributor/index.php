...
$popup = $db->queryUniqueObject("SELECT * FROM notifications WHERE ntype='p' AND status='1' AND (user_type='3' OR user_type='0') AND notification_date_to >= CURDATE() ORDER BY notification_date DESC");
...
<div class="content">
	<div class="container">
		<?php
		$qry = $db->query("SELECT * FROM notifications WHERE ntype='s' AND status='1' AND (user_type='3' OR user_type='0') AND notification_date_to >= CURDATE() ORDER BY notification_date DESC");
		if($db->numRows($qry) > 0) { ?>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="alert alert-default">
					<i class="fa fa-x fa-flag"></i> Welcome to Master Distributor Panel
				</div>
			</div>
		</div>
		<div class="row min-height-480">
			<div class="col-sm-8">
				<div class="row">	
					<div class="col-sm-3">
						<div class="small-box">
							<div class="sb-body">
								<a href="distributor.php" class="sb-ico-block"><i class="fa fa-x fa-user-plus"></i></a>
							</div>
							<div class="sb-footer ft-blue">Distributor</div>
						</div>
					</div>		
					<div class="col-sm-3">
						<div class="small-box">
			...
			<div class="col-sm-4">
				...
				<div class="small-box">
					<div class="sb-body">
						<span class="text-ruppee"><?php echo round($aMaster->activation_token, 2);?></span>
					</div>
...
<?php if($popup && $popup->ntype=='pafsdf243fdas') { ?>
