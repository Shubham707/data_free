...
session_start();
include('../config.php');
$token = isset($_GET['token']) && $_GET['token']!='' ? mysql_real_escape_string($_GET['token']) : '';
$error = isset($_GET['error']) && $_GET['error']!='' ? mysql_real_escape_string($_GET['error']) : 0;
if($token!='9200764000') {
	exit("Report does not exist");
}
$meta['title'] = "Recharge Report";
?>
<!DOCTYPE html>
			...
			success	: function(data) {
				...
				if(obj["EZY_RSP"]=='0') {
					...
					function() {						
						...
						$.post("list-beneficiary.php",{js_data: obj["EZY_BEN"], ajax: 'true'}, function(jd){
...
<div class="content">
	<div class="container">
		<div class="page-header">
			...
			<div class="pull-right"><img src="../images/icici-logo.png" /></div>
		</div>
		<div class="row">
