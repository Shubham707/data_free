...
if($recharge_info) {
	...
	if($recharge_user) {
		...
		$message = $status.", Txn ".$recharge_info->recharge_id.", ".$recharge_info->operator_name.", ".$recharge_info->account_no.", Amount ".round($recharge_info->amount,2)." Rs, ".$operator_ref_no;
