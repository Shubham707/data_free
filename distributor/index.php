...
include("common.php");
$error = 0 ;
$aParent = $db->queryUniqueObject("SELECT * FROM apps_user WHERE uid = '".$aDistributor->mdist_id."' ");
if($aParent) {
...
$popup = $db->queryUniqueObject("SELECT * FROM notifications WHERE ntype='p' AND status='1' AND (user_type='4' OR user_type='0') AND notification_date_to >= CURDATE() ORDER BY notification_date DESC");
...
<div class="content">
	<div class="container">
		<?php
		$qry = $db->query("SELECT * FROM notifications WHERE ntype='s' AND status='1' AND (user_type='4' OR user_type='0') AND notification_date_to >= CURDATE() ORDER BY notification_date DESC");
		if($db->numRows($qry) > 0) { ?>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="alert alert-default">
					<i class="fa fa-x fa-flag"></i> Welcome to Distributor Panel
				</div>
			</div>
		</div>		
		<div class="row min-height-480">
			<div class="col-sm-8">
				<div class="row">	
					<div class="col-sm-3">
						<div class="small-box">
							<div class="sb-body">
								<a href="retailer.php" class="sb-ico-block"><i class="fa fa-x fa-user-plus"></i></a>
							</div>
							<div class="sb-footer ft-blue">Retailer</div>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="small-box">
							<div class="sb-body">
								<a href="user-fund-request.php" class="sb-ico-block"><i class="fa fa-x fa-money"></i></a>
							</div>
					...
					<div class="col-sm-3">
						<div class="small-box">
							<div class="sb-body">
								<a href="fund-add.php?token=<?php echo $token;?>" class="sb-ico-block"><i class="fa fa-x fa-inr"></i></a>
							</div>
							<div class="sb-footer ft-blue">Fund Transfer</div>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="small-box">
			...
			<div class="col-sm-4">
				<div class="small-box">
					...
					<div class="sb-footer ft-green">Current Balance (<i class="fa fa-inr"></i>) / Cutoff: <i class="fa fa-inr"></i> <?php echo round($cutoff_balance, 2);?></div>
				</div>
				<div class="small-box">
					<div class="sb-body">
						<span class="text-ruppee"><?php echo round($aDistributor->activation_token, 2);?></span>
					</div>
					<div class="sb-footer ft-green">Token Available</div>
				</div>
				<div class="small-box">
					<div class="sb-body">
...
<?php if($popup && $popup->ntype=='pssss48t') { ?>
