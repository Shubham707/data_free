			...
			*/		
			...
			if($ds_wallet && (($ds_wallet->balance - $ds_wallet->cuttoff) >= $amount) && ($amount > 0)) {	
				...
				*/
				...
				$db->execute("INSERT INTO `transactions`(`transaction_date`, `account_id`, `to_account_id`, `type`, `amount`, `closing_balance`, `transaction_term`, `transaction_ref_no`, `remark`, `transaction_user_type`, `transaction_by`) VALUES (NOW(), '".$_SESSION['distributor_uid']."', '".$uid."', 'dr', '".$amount."', '".$ds_closing_balance."', 'FUND', '', '".$remark."', '4', '".$_SESSION['distributor_uid']."') ");
				...
				*/
				...
				$db->execute("INSERT INTO `transactions`(`transaction_date`, `account_id`, `to_account_id`, `type`, `amount`, `closing_balance`, `transaction_term`, `transaction_ref_no`, `remark`, `transaction_user_type`, `transaction_by`) VALUES (NOW(), '".$wallet->uid."', '".$_SESSION['distributor_uid']."', 'cr', '".$amount."', '".$closing_balance."', 'FUND', '', '".$remark."', '4', '".$_SESSION['distributor_uid']."') ");
