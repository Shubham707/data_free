...
$sWhere = "WHERE com.uid = '".$_SESSION['distributor_uid']."' AND com.added_date BETWEEN '".$aFrom."' AND '".$aTo."' AND com.added_date >= '".$aToDate."' ";
...
$limit = (int) (!isset($_GET["show"]) ? 200 : $_GET["show"]);
				...
				<table class="table table-condensed table-basic">
					...
					<tbody>
						...
						<tr>
							...
							<td align="right"><?php echo $result->added_date;?></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
