...
$request_txn_no = time();
$ezpmsg = "msg=E06021~".$ezykey."~".$request_txn_no."~".$otp_ref_code."~".$otp."~NA~NA";
$url = 'http://180.179.20.116:8030/RemitMoney/mtransfer';
if($otp=='123456') {
	$output = "E06022~".$ezykey."~".$account."~".$otp_ref_code."~NA~SUCCESS~Description~NA~NA";
} else {
	$output = "E06022~".$ezykey."~".$account."~".$otp_ref_code."~NA~FAILED~OTP not verified~NA~NA";
}
if($output) {	
