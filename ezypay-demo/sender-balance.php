...
$request_txn_no = time();
$ezpmsg = "msg=E06005~".$ezykey."~".$request_txn_no."~".$account."~NA~NA";
$url = 'http://180.179.20.116:8030/RemitMoney/mtransfer';

if($account=='7566309322') {
	$output = "E06006~".$ezykey."~".$account."~Samdy~NA~SUCCESS~Description~NA~NA";
} else {
	$output = "E06006~".$ezykey."~".$account."~NA~NA~FAILED~Request Failed, Try again later~NA~NA";
}
