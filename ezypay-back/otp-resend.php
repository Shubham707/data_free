 ...
 * E06019~E1hgYt898557843789~Abc589654130~16011~NA~NA
 */
$request_txn_no = time();
$ezpmsg = "msg=E06019~".$ezypay['key']."~".$request_txn_no."~".$otp_ref_code."~NA~NA";
...
if($output) {	
	...
	// E06020~ Abc589654130~7699999821~161101~Na~SUCCESS~Description~NA~NA
	//
