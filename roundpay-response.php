...
$db->query("INSERT INTO apps_reverse_response (api_id, reverse_response_content, response_time) VALUES ('6', '".$content."', NOW())");
			...
			if($api_status=='SUCCESS') {
				...
				*/
				...
				if($operator_info->operator_id=='20' && $amount>=90)
							...
							$db->execute("UPDATE apps_recharge SET status='8',api_id='11',org_api_id='6', status_details='Transaction Submitted', request_txn_no='".$request_txn_no."', api_txn_no='".mysql_real_escape_string($api_txn_no)."', api_status='".mysql_real_escape_string($api_status)."' WHERE recharge_id='".$recharge_id."' ");
