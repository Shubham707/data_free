...
if(isset($_POST['submit'])) {
	...
	if($_POST['mobile']=='' || $_POST['amount'] == '' || $_POST['pass'] == '') {
		...
		$url ="http://ajira.online/Jio.asmx/Recharge?macID=c4:0b:cb:64:60:7d&posID=101&userID=1234567890&cName=1234567890&password=".$pass."&number=".$mobile."&amount=".$amount;		
		$ch = curl_init();
