<?php
	...
	*/
	...
	$url ="http://ajira.online/Jio.asmx/Recharge?macID=c4:0b:cb:64:60:7d&posID=101&userID=1234567890&cName=1234567890&password=".$operator_info->password."&number=".$account."&amount=".$amount;
	...
	if($output) {
		...
		$amt_info = $db->queryUniqueObject("SELECT * FROM operators_denominations WHERE operator_id='".$operator_info->operator_id."' AND status='1' AND FIND_IN_SET ($amount, amount_values) ");
		if($amt_info) {
