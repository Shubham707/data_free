...
ob_start();
$data[] = array('S.No', 'Txn Date', 'User Details', 'Type', 'Amount', 'Commission', 'Debit Amount', 'Credit Amount', 'Closing Balance', 'Term', 'Ref Txn No', 'Remark', 'User Type', 'Transaction User');
...
while($result = $db->fetchNextObject($query)) {
	...
	$data[] = array($scnt++, $result->transaction_date, $result->company_name, $result->type, $amount_in, $amount_out, $debit_amount, $credit_amount, $result->closing_balance, $result->transaction_term, $result->transaction_ref_no, $result->remark, $result->transaction_user_type, $result->transaction_by);
} 
