				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><b><?php echo $result->user_category;?></b></td>
							...
							<td style="text-align:center;"><a href="distributor.php?mdist_id=<?php echo $result->uid;?>" title="Distributor" class="btn btn-xs btn-default"><i class="fa fa-user"></i></a></td>
							<td style="text-align:center;"><a href="retailer.php?muid=<?php echo $result->uid;?>" title="Retailer" class="btn btn-xs btn-default"><i class="fa fa-user"></i></a></td>
					...
					<tfoot>
						...
						<tr>
							<td align="right" colspan="7"><b>Total Balance</b></td>
