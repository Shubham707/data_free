			...
			for($i = 1; $i<=count($_POST['operator_id']); $i++) {
				...
				if($exists) {
					...
					if($_POST['user_type']=='1') {
						...
						$db->execute("INSERT INTO usercommissions(uid, operator_id, api_id, comm_mdist, comm_dist, comm_ret, commission_type, is_surcharge, surcharge_type, surcharge_value, status) values('".$request_id."', '".mysql_real_escape_string($_POST['operator_id'][$i])."','".$api_id[$i]."', '".mysql_real_escape_string($_POST['commission_md'][$i])."', '".mysql_real_escape_string($_POST['commission_ds'][$i])."', '".mysql_real_escape_string($_POST['commission_rt'][$i])."', '".$commission_type[$i]."', '".$is_surcharge[$i]."', '".$surcharge_type[$i]."', '".$_POST['surcharge_amt'][$i]."', '".$_POST['operator_status'][$i]."') ");
					}					
				}
			}
					...
					<div class="box-body no-padding min-height-480">
						...
						<table class="table table-condensed table-bordered">
							<tr>
								...
								<th width="10%">Master Distributor</th>	
							...
							<tr>
								...
								<?php if($user->user_type=='3') {?>	
								<td><input type="text" size="5" name="comm_md" id="comm_md" onchange="fill('md')" class="" placeholder="Enter" /></td>
							...
							<td align="center"><b><?php echo getCommissionType($commission_type=='p');?></b></td>						
								...
								<td>
									<input type="text" size="5" id="commission_md<?php echo $i;?>" name="commission_md[<?php echo $i;?>]" value="<?php echo $comm_mdist;?>" class="fill-md fill-Dexp" />
								</td>
								<td>
								...
								<td>
									<input type="text" size="5" id="commission_md<?php echo $i;?>" name="commission_md[<?php echo $i;?>]" value="<?php echo $comm_mdist;?>" class="fill-md fill-Dpre" />
								</td>
								<td>
								...
								<td>
									<input type="text" size="5" id="commission_md<?php echo $i;?>" name="commission_md[<?php echo $i;?>]" value="<?php echo $comm_mdist;?>" class="fill-md fill-Ddth" />
								</td>
								<td>
								...
								<td>
									<input type="text" size="5" id="commission_md<?php echo $i;?>" name="commission_md[<?php echo $i;?>]" value="<?php echo $comm_mdist;?>" class="fill-md fill-Ddexp" />
								</td>
								<td>
								...
								<?php } else{?>
								<td>
									<input type="text" size="5" id="commission_md<?php echo $i;?>" name="commission_md[<?php echo $i;?>]" value="<?php echo $comm_mdist;?>" class="fill-md " />
								</td>
								<td>
