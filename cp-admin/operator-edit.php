...
if(isset($_POST['submit'])) {
	if($_POST['service_type'] == '' || $_POST['operator_name'] == '' || $_POST['operator_code'] == '') {
		...
		if($exists) {
			...
			$db->execute("UPDATE `operators` SET `operator_name`='".$operator_name."', `operator_code`='".$operator_code."', `operator_longcode`='".$operator_longcode."', `service_type`='".$_POST['service_type']."', `billing_type`='".$_POST['billing_type']."', `hsn_sac_code`='".$hsn_sac_code."', `minimum_amount`='".$min_amount."', `maximum_amount`='".$max_amount."', `code_egpay`='".$code_egpay."', `service_type_egpay`='".$service_type_egpay."', `code_arroh`='".$code_arroh."', `code_achariya`='".$code_achariya."', `code_echarge`='".$code_echarge."', `service_type_echarge`='".$service_type_echarge."', `code_roundpay`='".$code_roundpay."', `code_rechargeatz`='".$code_rechargeatz."', `code_exioms`='".$code_exioms."', `service_type_exioms`='".$service_type_exioms."', `code_aarav`='".$code_aarav."', `service_type_aarav`='".$service_type_aarav."', `code_ambika`='".$code_ambika."', `code_cyberplat`='".$code_cyberplat."', `code_offline`='".$code_offline."', `code_ezypay`='".$code_ezypay."', `api_id`='".$_POST['api']."', `commission_type`='".$_POST['commission_type']."', `is_surcharge`='".$_POST['is_surcharge']."', `surcharge_type`='".$_POST['surcharge_type']."', `surcharge_value`='".$sur_amount."', `is_auto_switch`='".$is_auto_switch."', `is_express`='".$_POST['is_express']."', `status`='".$_POST['status']."' WHERE operator_id = '".$request_id."' ");
			$error = 3;
		}		
	}
}
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<div class="row">
									...
									<div class="col-sm-9">
										<p class="form-control-static">Cyberplat API</p>
									</div>
								</div>								
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<div class="row">
									<div class="col-xs-7">
										<input type="text" name="code_echarge" id="code_echarge" value="<?php echo $operator->code_echarge;?>" class="form-control" placeholder="CLICK ECHARGE OPERATOR CODE">
									</div>
									<div class="col-xs-5">
										<input type="text" name="service_type_echarge" id="service_type_echarge" value="<?php echo $operator->service_type_echarge;?>" class="form-control" placeholder="CLICK ECHARGE SERVICE TYPE">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<input type="text" name="code_ezypay" id="code_ezypay" value="<?php echo $operator->code_ezypay;?>" class="form-control" placeholder="EZYPAY OPERATOR CODE">
							</div>
						</div>
