...
if(isset($_POST['submit'])) {
	if($_POST['service_type'] == '' || $_POST['operator_name'] == '' || $_POST['operator_code'] == '') {
		...
		$code_echarge = htmlentities(addslashes($_POST['code_echarge']),ENT_QUOTES);
		$service_type_echarge = htmlentities(addslashes($_POST['service_type_echarge']),ENT_QUOTES);
		...
		$code_ezypay = htmlentities(addslashes($_POST['code_ezypay']),ENT_QUOTES);
		...
		if($exists) {
			...
			$db->execute("INSERT INTO `operators`(`operator_id`, `operator_name`, `operator_code`, `operator_longcode`, `service_type`, `billing_type`, `hsn_sac_code`, `minimum_amount`, `maximum_amount`, `code_egpay`, `service_type_egpay`, `code_arroh`, `code_achariya`, `code_echarge`, `service_type_echarge`, `code_roundpay`, `code_rechargeatz`, `code_exioms`, `service_type_exioms`, `code_aarav`, `service_type_aarav`, `code_ambika`, `code_cyberplat`, `code_offline`, `code_ezypay`, `api_id`, `commission_type`, `is_surcharge`, `surcharge_type`, `surcharge_value`, `status`) VALUES ('', '".$operator_name."', '".$operator_code."', '".$operator_longcode."', '".$_POST['service_type']."', '".$_POST['billing_type']."', '".$hsn_sac_code."', '".$min_amount."', '".$max_amount."', '".$code_egpay."', '".$service_type_egpay."', '".$code_arroh."', '".$code_achariya."', '".$code_echarge."', '".$service_type_echarge."', '".$code_roundpay."', '".$code_rechargeatz."', '".$code_exioms."', '".$service_type_exioms."', '".$code_aarav."', '".$service_type_aarav."', '".$code_ambika."', '".$code_cyberplat."', '".$code_offline."', '".$code_ezypay."', '".$_POST['api']."', '".$_POST['commission_type']."', '".$_POST['is_surcharge']."', '".$_POST['surcharge_type']."', '".$_POST['sur_amount']."', '".$_POST['status']."')");
			$error = 3;
		}		
	}
}
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<label class="radio-inline">
									<input type="radio" name="commission_type" id="comm_type_per" value="p" checked="checked"> Percentage
								</label>
								<label class="radio-inline">
									<input type="radio" name="commission_type" id="comm_type_flat" value="f"> Flat in (Rs)
								</label>
							</div>
						</div>	
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<label class="radio-inline">
									<input type="radio" name="surcharge_type" id="surcharge_type_no" value="f" checked="checked"> Fixed
								</label>
								<label class="radio-inline">
									<input type="radio" name="surcharge_type" id="surcharge_type_yes" value="p"> Percentage
								</label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<label class="radio-inline">
									<input type="radio" name="billing_type" id="billing_type_p2p" value="1" checked="checked"> P2P (Principle to Principle)
								</label>
								<label class="radio-inline">
									<input type="radio" name="billing_type" id="billing_type_p2a" value="2"> P2A (Principle to Agent)
								</label>								
								<label class="radio-inline">
									<input type="radio" name="billing_type" id="billing_type_p2s" value="3"> P2A (Surcharge)
								</label>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<input type="text" name="code_arroh" id="code_arroh" class="form-control" placeholder="ARROH OPERATOR CODE">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">CLICK ECHARGE :</label>
							<div class="col-sm-8 jrequired">
								<div class="row">
									<div class="col-xs-7">
										<input type="text" name="code_echarge" id="code_echarge" class="form-control" placeholder="CLICK ECHARGE OPERATOR CODE">
									</div>
									<div class="col-xs-5">
										<input type="text" name="service_type_echarge" id="service_type_echarge" class="form-control" placeholder="CLICK ECHARGE SERVICE TYPE">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 jrequired">
								<input type="text" name="code_rechargeatz" id="code_rechargeatz" class="form-control" placeholder="RECHARGE A2Z OPERATOR CODE">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">EZYPAY :</label>
							<div class="col-sm-8 jrequired">
								<input type="text" name="code_ezypay" id="code_ezypay" class="form-control" placeholder="EZYPAY OPERATOR CODE">
							</div>
						</div>
