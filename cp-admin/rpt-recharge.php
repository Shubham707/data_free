...
$sWhere = "WHERE recharge.request_date BETWEEN DATE_SUB(NOW(), INTERVAL 1 MONTH) AND '".$aTo."' ";
...
if(isset($_GET['org_status']) && $_GET['org_status']!='') {
	$sWhere .= " AND recharge.org_status='".mysql_real_escape_string($_GET['org_status'])."' AND recharge.status!='3'";
}
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a class="fancyStatus fancybox.ajax label <?php echo $rch_status[1];?>" href="recharge-status-update.php?id=<?php echo $result->recharge_id;?>" title="Update Recharge Status"><?php echo $rch_status[0];?></a>
							</td>
