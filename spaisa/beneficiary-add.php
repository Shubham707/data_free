...
$url = "http://99-604-99-605.com/api/money-transfer.php?userid=".$echarge['uid']."&key=".$echarge['key']."&request=".$_GET['request']."&mobile=".$account."&ben_name=".urlencode($ben_name)."&ben_account=".$ben_account."&ifsc=".$ifsc;
