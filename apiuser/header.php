...
<div class="header">
	<div class="container">
		<div class="logo pull-left">
			<img class="logo_size" src="../uploads/<?php echo $website['logo'];?>" />
		</div>		
		<ul class="nav navbar-nav pull-right">
			<p class="navbar-text"><?php echo $aAPIUser->company_name;?> [ <?php echo $_SESSION['apiuser_uid'];?> ]</p>
			<li class="dropdown pull-right">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">My Account <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="profile.php?token=<?php echo $token;?>">Profile</a></li>
					<li><a href="kyc.php?token=<?php echo $token;?>">KYC</a></li>
			...
			<div id="dr-menu" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="fund-request.php?token=<?php echo $token;?>">Fund Request</a></li>
							<li><a href="rpt-fund-request.php">Fund Request Histroy</a></li>
							<li><a href="rpt-fund-transfer.php">Fund Transfer Histroy</a></li>
						</ul>						
					</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="rpt-callback.php">Call Back Report</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Developer API <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="api-setting.php?token=<?php echo $token;?>">API Setting</a></li>
							<li><a href="reverse-notification.php">Reverse Notification</a></li>
							<li><a href="operator.php">Operators</a></li>
							<li><a href="api-document-download.php">Downloads Document</a></li>
						</ul>
					</li>						
				</ul>				
			</div>
