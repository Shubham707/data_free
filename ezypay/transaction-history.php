 ...
 * E06025~E1hgYt898557843789~Abc589654127~7699999821~NA~NA
 */
$request_txn_no = time();
$ezpmsg = "msg=E06025~".$ezypay['key']."~".$request_txn_no."~".$account."~NA~NA";
...
if($output) {	
	...
	if(json_decode($output)) {
		...
		$jsDmtResponse = '{"EZY_RSP":"0","EZY_MSG":"Transaction fetched successfully","EZY_MOB":"'.$account.'","EZY_TXN":'.$jsDataTxn.'}';
	} else {
