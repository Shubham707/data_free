 ...
 * MessageCode~ Auth Code~ Request id~ Mobile No~ Name~ Value1~ Value2
 */
$request_txn_no = time();
$ezpmsg = "msg=E06003~".$ezypay['key']."~".$request_txn_no."~".$account."~".$name."~NA~NA";
...
if($output) {	
	...
	// E06004~ Abc589654123~7699999821~Sandy~161101~SUCCESS~Description~NA~ NA
	//
